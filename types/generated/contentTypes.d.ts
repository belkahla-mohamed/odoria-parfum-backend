...
export interface ApiOfferOffer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::offer.offer'> &
      Schema.Attribute.Private;
    priceAfter: Schema.Attribute.Integer;
    priceBefore: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOrderItemOrderItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    packData: Schema.Attribute.Component<'order.pack-datum', false>;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    shippingAddress: Schema.Attribute.Component<'order.address', false>;
...
export interface ApiPackPack extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cartItemPack: Schema.Attribute.Relation<
      'oneToOne',
      'api::cart-item.cart-item'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    favoritePack: Schema.Attribute.Relation<
      'oneToOne',
      'api::favorite.favorite'
    >;
    imageURL: Schema.Attribute.String;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['fixed', 'customizable']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cartItemProduct: Schema.Attribute.Relation<
      'oneToOne',
      'api::cart-item.cart-item'
    >;
    ...
    favoriteProduct: Schema.Attribute.Relation<
      'oneToOne',
      'api::favorite.favorite'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    notes: Schema.Attribute.Component<'product.perfume-note', false>;
    orderItems: Schema.Attribute.Relation<
      'oneToMany',
      'api::order-item.order-item'
    >;
